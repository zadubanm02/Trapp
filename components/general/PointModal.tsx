  ...
  return (
    ...
    >
      ...
      <Modal.Body className="m-5">
        ...
        />
        <Text className="my-3">
          Na základe tvojej pani dôležitých otázok si zodpovedaj na kolko bodov
          si dnes bol dobrý partner do života. Bol si doma? Splnil si základné
          povinnosti? Odpovedz si na základné otázky a oboduj -10 až 10.
        </Text>
